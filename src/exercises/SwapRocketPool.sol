...
contract SwapRocketPool {
        ...
        returns (uint256 rEthAmount, uint256 fee)
    {
        ...
        uint256 ethFee = protocolSettings.getDepositFee();
        //ETH PER rETH ALWAYS GOING TO BE LESS THAN 1
        fee = (ethAmount * ethFee) / CALC_BASE;
        ethAmount -= fee;
    ...
    {
        // Write your code here
        depositEnabled = protocolSettings.getDepositEnabled();
        maxDepositAmount = depositPool.getMaximumDepositAmount();
    ...
    function getDepositDelay() public view returns (uint256 depositDelay) {
        // Write your code here
        depositDelay = rStorage.getUint(
            keccak256(
                abi.encodePacked(
        ...
        returns (uint256 lastDepositBlock)
    {
        ...
        lastDepositBlock = rStorage.getUint(key);
    ...
    function swapRethToEth(uint256 rEthAmount) external {
        ...
        // reth.approve(address(this),rEthAmount);
