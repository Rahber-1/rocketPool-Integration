...
contract RocketPoolViewTest is RocketPoolTestBase {
    ...
    function test_AllContractsWorking() public {
        console.log("address of reth is: ", address(reth));
        console.log("address of deposit pool is: ", address(depositPool));
        console.log("address of rstorage is: ", address(rStorage));
        console.log(
            "address of protocolSettings is: ", address(protocolSettings)
        );
    }
}
